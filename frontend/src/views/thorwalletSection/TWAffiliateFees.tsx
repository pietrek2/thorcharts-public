...
const TWAffiliateFees = () => {
	const [dataSeries, setDataSeries] = useState<IChart[] | undefined>(undefined)
	const InitializeData = async () => {
		try {
			const chartData = (await getBackendData('thorwallet', 'tw_affiliate_fees')) as IAffilateFeesSpecified[]
	...
	if (dataSeries !== undefined) {
		return (
			<ChartPage
				chartTitle="[TW]: Affiliate Fees Earned"
				chartDesc="Affiliate fees earned by THORWallet."
...
export default TWAffiliateFees
